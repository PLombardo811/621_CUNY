...
training_2a_clean <- na.omit(training_2a)
M11 <- lm( TARGET_FLAG~ .-TARGET_FLAG, data = training_2a_clean)
...
ins.train_clean <- na.omit(ins.train)
core.glm <- glm(TARGET_FLAG ~  . -TARGET_AMT, data = ins.train_clean)
